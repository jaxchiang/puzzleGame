 ...
 /* ---------------------------------------拼图分割的每个小部分的功能书写------------------------------------------------ */
	...
	Dogod.mix(Puzz.prototype, {
		...
		drawing:function(x, y){
			Dogod.dom.append(this.wrap, this.ele);
		},
...
/* -----------------------------简单模态框的启动与关闭----------------------------------------- */
function overlay(){
    var e1 = Dogod.dom.$('modal-overlay');           
...
window.onload=function(){
	var game = new Puzzie('puzz', 520, 300, 'images/test.jpg', 4, false);
    game.start();
}
